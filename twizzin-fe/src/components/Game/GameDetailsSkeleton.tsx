...
const GameDetailsSkeleton = () => {
  return (
    <Column className='gap-12 w-full h-full flex-1' justify='start'>
      <div className='flex h-[60px] mt-4 justify-center items-center self-stretch rounded-lg bg-[#FBF9E9] gap-4 w-full max-w-small mx-auto text-[14px] active:opacity-80'></div>
